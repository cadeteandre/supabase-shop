import postNewCustomer, { ICustomer } from "../utils/fetches/postNewCustomer";
...
const AddUser = () => {
    ...
    return (  
        <section className="border rounded-xl p-2 mt-4 mx-auto flex flex-col items-center gap-2">
            <form onSubmit={handleNewCustomer} className="flex flex-col items-center gap-2 w-60">
                ...
                <label className="input input-bordered flex items-center gap-2">
                    ...
                    <input name="firstName" type="text" className="grow" placeholder="Firstname" />
                </label>
                <label className="input input-bordered flex items-center gap-2">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <input name="lastName" type="text" className="grow" placeholder="Lastname" />
                </label>
                <label className="input input-bordered flex items-center gap-2">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
